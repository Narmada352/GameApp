...
class LeaderboardActivity : AppCompatActivity() {
    ...
    private fun fetchLeaderboardScores() {
        val dreamloAPI = "http://dreamlo.com/lb/6713d8e88f40bc122c28111f/json"
            ...
            override fun onResponse(call: Call, response: Response) {
                if (response.isSuccessful) {
                    ...
                    try {
                        ...
                        val leaderboard = leaderboardObject.getJSONObject("leaderboard")
                        // Check if the leaderboard exists and is not null
//                        if (leaderboard.) {
                            val leaderboardData = leaderboard.getJSONArray("entry")
